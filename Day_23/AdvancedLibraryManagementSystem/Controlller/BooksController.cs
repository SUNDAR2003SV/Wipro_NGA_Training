...
namespace LibraryManagementSystem.Controllers
{
    public class BooksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("BookId,Title,Price,PublishedYear,AuthorId,GenreId")] Book book)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BookId,Title,Price,PublishedYear,AuthorId,GenreId")] Book book)
        {
            if (id != book.BookId)
            {
                return NotFound();
